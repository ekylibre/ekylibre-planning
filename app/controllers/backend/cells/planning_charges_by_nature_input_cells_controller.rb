module Backend
  module Cells
    class PlanningChargesByNatureInputCellsController < Backend::Cells::BaseController
      ...
      def show
        @title_cel = :planning_charges_by_nature_input_cell_title.tl
        ...
        items = DailyCharge.between_date(started_on, stopped_on).of_type('input')
