...
module Planning
  module Backend
    class ProductsController < ::Backend::ProductsController
      unroll :name, :number, :work_number, :identification_number, container: :name,
                                                                   partial: 'planning/backend/interventions/available_time_or_quantity', custom_sort: :sort_by_time_use
