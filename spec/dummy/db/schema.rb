...
ActiveRecord::Schema.define(version: 20180405125117) do
  ...
  add_index "activity_production_batches", ["activity_production_id"], name: "activity_production_batch_id", using: :btree
  ...
  add_index "activity_production_irregular_batches", ["activity_production_batch_id"], name: "activity_production_irregular_batch_id", using: :btree
  ...
  add_index "activity_productions", ["technical_itinerary_id"], name: "index_activity_productions_on_technical_itinerary_id", using: :btree
  ...
  add_index "daily_charges", ["activity_production_id"], name: "index_daily_charges_on_activity_production_id", using: :btree
  add_index "daily_charges", ["intervention_template_product_parameter_id"], name: "intervention_template_product_parameter_id", using: :btree
  ...
  add_index "intervention_proposals", ["activity_production_id"], name: "index_intervention_proposals_on_activity_production_id", using: :btree
  add_index "intervention_proposals", ["technical_itinerary_intervention_template_id"], name: "technical_itinerary_intervention_template_id", using: :btree
  ...
  add_index "intervention_template_activities", ["activity_id"], name: "index_intervention_template_activities_on_activity_id", using: :btree
  add_index "intervention_template_activities", ["intervention_template_id"], name: "intervention_template_activity_id", using: :btree
  ...
  add_index "intervention_template_product_parameters", ["activity_id"], name: "index_intervention_template_product_parameters_on_activity_id", using: :btree
  add_index "intervention_template_product_parameters", ["intervention_template_id"], name: "intervention_template_id", using: :btree
  add_index "intervention_template_product_parameters", ["product_nature_id"], name: "product_nature_id", using: :btree
  add_index "intervention_template_product_parameters", ["product_nature_variant_id"], name: "product_nature_variant_id", using: :btree
  ...
  add_index "intervention_templates", ["campaign_id"], name: "index_intervention_templates_on_campaign_id", using: :btree
  ...
  add_index "interventions", ["intervention_proposal_id"], name: "index_interventions_on_intervention_proposal_id", using: :btree
  ...
  add_index "technical_itinerary_intervention_templates", ["intervention_template_id"], name: "itinerary_template_id", using: :btree
  add_index "technical_itinerary_intervention_templates", ["technical_itinerary_id"], name: "template_itinerary_id", using: :btree
